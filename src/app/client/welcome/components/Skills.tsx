			...
			<section className="skills" id="Навыки">
				<div className="skills-content section-content">
					...
					<p className="section-text">
						Делаю интерфейсы, в которых не нужно разбираться — всё работает с первого клика. Быстро, удобно и с заботой о
						пользователе.
					</p>

					<div className={`skills-toggle ${skillsTab === "tools" ? "active" : ""}`} data-toggle-box>
						<button
				...
				<div className={`skills-box ${skillsTab === "tools" ? "active" : ""}`} data-skills-box>
							...
							<li key={index}>
								<div className="skills-card">
									...
									<div className="card-icon">
										<Image width={40} height={40} src={skill.img} alt={`${skill.name} logo`} loading="lazy" />
									</div>
								</div>
							</li>
						))}
						...
						{toolsList.map((tool, index) => (
							<li key={index}>
								<div className="skills-card">
									...
									<div className="card-icon">
										<Image width={40} height={40} src={tool.img} alt={`${tool.name} logo`} loading="lazy" />
									</div>
								</div>
							</li>
						))}
