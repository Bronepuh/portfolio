...
const BongoCat: React.FC = () => {
  ...
  return (
    <div className="bongo-container">
      ...
      >
        <defs>
          <symbol id="eye" viewBox="0 0 19.2 18.7">
          ...
          <symbol id="paw-pads" viewBox="0 0 31.4 33.9">
            <path
            ...
            <g id="laptop__code">
              ...
              >
                <g id="f3" transform="translate(0 76)">
                  <path d="M8,25L8,25" strokeDasharray="60,10">
                    <animate
                      attributeName="d"
                      begin="0s"
                      dur="1.2s"
                      repeatCount="indefinite"
                      values="M8,25L8,25;M8,25L96,25;M8,25L96,25"
                    />
                  </path>
                  <path d="M8,13L8,13" strokeDasharray="50,10">
                    <animate
                      attributeName="d"
                      begin="0.4s"
                      dur="1.2s"
                      repeatCount="indefinite"
                      values="M8,13L8,13;M8,13L146,13;M8,13L146,13"
                    />
                  </path>
                  <path d="M0,1L0,1" strokeDasharray="25,10">
                    <animate
                      attributeName="d"
                      begin="0.8s"
                      dur="1.2s"
                      repeatCount="indefinite"
                      values="M0,1L0,1;M0,1L96,1;M0,1L96,1"
                    />
                  </path>
                </g>
                <g id="f2" transform="translate(0 38)">
                  <path d="M8,25L8,25" strokeDasharray="40,10">
                    <animate
                      attributeName="d"
                      begin="1.2s"
                      dur="1.2s"
                      repeatCount="indefinite"
                      values="M8,25L8,25;M8,25L69,25;M8,25L69,25"
                    />
                  </path>
                  <path d="M8,13L8,13" strokeDasharray="60,10">
                    <animate
                      attributeName="d"
                      begin="1.6s"
                      dur="1.2s"
                      repeatCount="indefinite"
                      values="M8,13L8,13;M8,13L114,13;M8,13L114,13"
                    />
                  </path>
                  <path d="M0,1L0,1" strokeDasharray="30,10">
                    <animate
                      attributeName="d"
                      begin="2s"
                      dur="1.2s"
                      repeatCount="indefinite"
                      values="M0,1L0,1;M0,1L136,1;M0,1L136,1"
                    />
                  </path>
                </g>
                <g id="f1">
                  <path d="M8,25L8,25" strokeDasharray="60,10">
                    <animate
                      ...
                      dur="1.2s"
                      repeatCount="indefinite"
                      values="M8,25L8,25;M8,25L61,25;M8,25L61,25"
                    />
                  </path>
                  <path d="M8,13L8,13" strokeDasharray="60,10">
                    <animate
                      ...
                      dur="1.2s"
                      repeatCount="indefinite"
                      values="M8,13L8,13;M8,13L124,13;M8,13L124,13"
                    />
                  </path>
                  <path d="M0,1L0,1" strokeDasharray="60,10">
                    <animate
                      attributeName="d"
                      begin="3.2s"
                      dur="1.2s"
                      repeatCount="indefinite"
                      values="M0,1L0,1;M0,1L160,1;M0,1L160,1"
                    />
                  </path>
                </g>
              </g>
